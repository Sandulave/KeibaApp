<x-app-layout title="購入馬券作成（{{ $race->name }}）">
    ...
    <style>
        #umarenNagashi1Axis .combo-scroll { scrollbar-width: thin; }
        #umarenNagashi1Axis .combo-scroll::-webkit-scrollbar { width: 6px; height: 6px; }
        #umarenNagashi1Axis .combo-scroll::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 9999px; }
        #umarenNagashi1Axis .combo-scroll::-webkit-scrollbar-track { background: transparent; }
    </style>

    <div id="umarenNagashi1Axis" class="space-y-4">
        ...
        <form method="POST" action="{{ route('bet.cart.add', $race) }}" class="space-y-4">
            ...
            <input type="hidden" name="betType" value="{{ $betType ?? 'umaren' }}">
            ...
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-4 space-y-4">
                <div class="flex items-center justify-between gap-3">
                    <h2 class="text-base font-semibold">馬連 1頭軸流し</h2>
                </div>

                <div class="text-sm text-gray-600 leading-relaxed">
                    軸馬を1頭、相手を1頭以上選びます。<br>
                    馬連は順不同なので、表示は <strong>昇順（1-2）</strong> に固定します。
                </div>
                        ...
                        <div class="sticky top-4 space-y-4">
                            ...
                            <div class="rounded-xl ring-1 ring-gray-200 bg-white overflow-hidden">
                                <div class="bg-indigo-600 text-white px-4 py-3">
                                    <div class="text-sm font-semibold">馬連 1頭軸流し</div>
                                </div>
                                ...
                                <div class="p-4 space-y-3">
                                    <div class="flex items-end justify-between">
                                        <div>
                                            ...
                                            <div class="text-4xl font-bold text-gray-900">
                                                <span id="tickets">0</span><span class="text-lg ml-1">点</span>
                                            </div>
                                        </div>
                                    ...
                                    <button id="submitBtn" type="submit" class="w-full rounded-xl bg-gradient-to-r from-red-500 to-red-600 px-4 py-3 text-white font-semibold shadow-md hover:opacity-90 transition">
                                        まとめてカートに追加
                                    </button>
                                </div>
                            </div>
    ...
    <script>
        (() => {
            ...
            function buildPairs(axis, opp) {
                ...
                return Array.from(set).sort((u, v) => {
