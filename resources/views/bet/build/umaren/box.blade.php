<x-app-layout title="購入馬券作成（{{ $race->name }}）">
    ...
    <style>
        #umarenBox .combo-scroll {
            scrollbar-width: thin;
        }

        #umarenBox .combo-scroll::-webkit-scrollbar {
            width: 6px;
            height: 6px;
        }

        #umarenBox .combo-scroll::-webkit-scrollbar-thumb {
            background: #cbd5e1;
            border-radius: 9999px;
        }

        #umarenBox .combo-scroll::-webkit-scrollbar-track {
            background: transparent;
        }
    </style>

    <div id="umarenBox" class="space-y-4">
        ...
        <form method="POST" action="{{ route('bet.cart.add', $race) }}" class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-4 space-y-4">
                <div class="flex items-center justify-between gap-3">
                    <h2 class="text-base font-semibold">馬連 ボックス</h2>
                </div>
                        ...
                        <div class="sticky top-4 space-y-4">
                            ...
                            <div class="rounded-xl ring-1 ring-gray-200 bg-white overflow-hidden">
                                <div class="bg-indigo-600 text-white px-4 py-3">
                                    <div class="text-sm font-semibold">馬連 ボックス</div>
                                </div>
        ...
        (() => {
            ...
            function renderPairs(horses) {
                const {
                    pairs,
                    total
                } = buildPairs(horses, MAX_COMBO_PREVIEW);
