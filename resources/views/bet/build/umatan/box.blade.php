<x-app-layout title="購入馬券作成（{{ $race->name }}）">
    ...
    <style>
        #umatanBox .combo-scroll {
            scrollbar-width: thin;
        }

        #umatanBox .combo-scroll::-webkit-scrollbar {
            width: 6px;
            height: 6px;
        }

        #umatanBox .combo-scroll::-webkit-scrollbar-thumb {
            background: #cbd5e1;
            border-radius: 9999px;
        }

        #umatanBox .combo-scroll::-webkit-scrollbar-track {
            background: transparent;
        }
    </style>

    <div id="umatanBox" class="space-y-4">
        ...
        <form method="POST" action="{{ route('bet.cart.add', $race) }}" class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-4 space-y-4">
                <div class="flex items-center justify-between gap-3">
                    <h2 class="text-base font-semibold">馬単 ボックス</h2>
                </div>

                <div class="text-sm text-gray-600 leading-relaxed">
                    2頭以上選ぶと、全順列（n×(n-1)）で自動生成します。<br>
                        ...
                        <div class="sticky top-4 space-y-4">
                            ...
                            <div class="rounded-xl ring-1 ring-gray-200 bg-white overflow-hidden">
                                <div class="bg-indigo-600 text-white px-4 py-3">
                                    <div class="text-sm font-semibold">馬単 ボックス</div>
                                </div>
